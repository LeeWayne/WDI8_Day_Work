...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { genre: @music.genre, members: @music.members, name: @music.name, popular_song: @music.popular_song }
    end
  ...
  test "should update music" do
    put :update, id: @music, music: { genre: @music.genre, members: @music.members, name: @music.name, popular_song: @music.popular_song }
    assert_redirected_to music_path(assigns(:music))
  end
